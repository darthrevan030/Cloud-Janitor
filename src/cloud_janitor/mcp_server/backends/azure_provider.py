...
class AzureProvider(CloudProvider):
    ...
    def __init__(self) -> None:
        logger.warning(
            "Azure support is not yet implemented. "
    ...
    def get_cost_data(self, resource_type: Optional[str] = None, min_idle_days: int = 7) -> dict:
        ...
        """
        raise NotImplementedError("AzureProvider.get_cost_data() is not yet implemented")
    ...
    def get_security_data(self, check_type: Optional[str] = None) -> dict:
        ...
        Raises:
            NotImplementedError: This method is not yet implemented.
        """
        raise NotImplementedError("AzureProvider.get_security_data() is not yet implemented")
    ...
    def check_dependencies(self, resource_id: str) -> dict:
        ...
        Raises:
            NotImplementedError: This method is not yet implemented.
        """
        raise NotImplementedError("AzureProvider.check_dependencies() is not yet implemented")
